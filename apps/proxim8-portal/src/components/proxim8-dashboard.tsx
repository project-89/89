...
export default function Proxim8Dashboard({ proxim8Id, onClose, isFullPage = false }: Proxim8DashboardProps) {
  const [activeTab, setActiveTab] = useState("overview")
  const [chatMessages, setChatMessages] = useState<{ role: "user" | "proxim8"; content: string }[]>([
  ...
  const handleSendMessage = () => {
    ...
    // Add user message
    setChatMessages((prev) => [...prev, { role: "user", content: messageInput }])
    ...
    setTimeout(() => {
      ...
      setChatMessages((prev) => [...prev, { role: "proxim8", content: response }])
    }, 1000)
  }
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              ...
              <div>
                ...
                <CardDescription className="flex flex-wrap items-center gap-2 mt-2">
                  <Badge className="bg-purple-900/20 text-purple-400">Level {proxim8.level}</Badge>
                  <Badge
                    className={cn(
                  ...
                  {proxim8.specialization && (
                    <Badge className="bg-yellow-900/20 text-yellow-400">{proxim8.specialization} specialist</Badge>
                  )}
                </CardDescription>
              </div>
                ...
                <div className="space-y-2">
                  {Object.entries(proxim8.attributes).map(([key, value]) => (
                    <div key={key} className="grid grid-cols-[1fr,auto,1fr] items-center gap-2">
                      ...
                      <div className="text-xs font-mono text-purple-400">{value}</div>
                      <Progress value={value} className="h-1 bg-gray-800" indicatorClassName="bg-purple-500" />
                    </div>
                  ))}
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {proxim8.skills.map((skill) => (
                      <div key={skill.name} className="bg-gray-800 p-2 rounded-md">
                        <div className="flex justify-between items-center">
                          <span className="text-sm font-medium">{skill.name}</span>
                          <Badge className="bg-yellow-900/20 text-yellow-400">Lvl {skill.level}</Badge>
                        </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-gray-800 p-2 rounded-md">
                      ...
                      <div className="text-lg font-bold text-green-400">{proxim8.successRate}%</div>
                    </div>
                    <div className="bg-gray-800 p-2 rounded-md">
                      <div className="text-xs text-gray-400">Missions</div>
                      <div className="text-lg font-bold">{proxim8.missionCount}</div>
                    </div>
                  </div>
                </div>
              </CardContent>
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <CardContent className="pt-6">
                  <TabsContent value="overview" className="m-0 space-y-6">
                    <div>
                      <h2 className="text-lg font-medium mb-3">Proxim8 Profile</h2>
                      <div className={cn("p-4 rounded-md border-2", getPersonalityColor())}>
                        <div className="flex items-center gap-2 mb-2">
                          {getPersonalityIcon()}
                          <span className="font-medium capitalize">{proxim8.personality} Personality</span>
                        </div>
                        <p className="text-sm text-gray-300">{getPersonalityDescription()}</p>
                      </div>
                    </div>

                    {proxim8.status === "deployed" && proxim8.mission && (
                      <div>
                        <h2 className="text-lg font-medium mb-3">Current Mission</h2>
                        <Card className="bg-gray-800 border-gray-700">
                          <CardHeader className="pb-2">
                            ...
                            <CardTitle className="text-base mt-2">{proxim8.mission.title}</CardTitle>
                          </CardHeader>
                          <CardContent className="pb-2">
                            <div className="text-xs text-gray-400 mb-3">{proxim8.mission.description}</div>
                              ...
                              <div className="flex justify-between text-xs mb-1">
                                ...
                                <span>
                                  {proxim8.mission.missionEndTime
                                    ? Math.round(
                                        ((Date.now() - (proxim8.mission.missionEndTime - 2 * 60 * 1000)) /
                                          (2 * 60 * 1000)) *
                                          100,
                                      )
                                    : 50}
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {proxim8.missionHistory.slice(0, 3).map((mission) => (
                          <div key={mission.id} className="bg-gray-800 p-3 rounded-md">
                            ...
                            <div className="flex items-center gap-2 mt-2 text-xs">
                              ...
                              <span className="capitalize">{mission.approach}</span>
                              <span className="text-purple-400 ml-auto">+{mission.rewardXP} XP</span>
                            </div>
                          </div>
                        ))}
                      </div>
                      ...
                      {proxim8.specialization ? (
                        <div className="bg-yellow-900/20 border border-yellow-800 p-4 rounded-md">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="font-medium capitalize">{proxim8.specialization} Specialist</span>
                          </div>
                          <p className="text-sm text-gray-300">
                            This Proxim8 has specialized in {proxim8.specialization} missions, gaining a +15% success
                            bonus when deployed on these mission types.
                          </p>
                        </div>
                      ) : (
                        <div className="bg-gray-800 p-4 rounded-md">
                          <p className="text-sm text-gray-300">
                            This Proxim8 has not yet developed a specialization. Complete more missions of a specific
                            type to develop a specialization.
                          </p>
                        </div>
                      )}
                    </div>
                          ...
                          >
                            <div
                              className={cn(
                                ...
                                message.role === "user" ? "bg-green-900/30 text-green-50" : "bg-gray-800 text-gray-100",
                              )}
                            >
                      ...
                      {proxim8.missionHistory.map((mission) => (
                        <Card key={mission.id} className="bg-gray-800 border-gray-700">
                          <CardHeader className="pb-2">
                            ...
                            <CardTitle className="text-base mt-2">{mission.title}</CardTitle>
                          </CardHeader>
                          <CardContent>
                            <div className="flex items-center gap-2 mb-3 text-sm">
                              {getApproachIcon(mission.approach)}
                              <span className="capitalize">{mission.approach} approach</span>
                            </div>
                            <div className="bg-gray-700 p-3 rounded-md">
                              <div className="text-xs text-gray-300 mb-2">Mission Report:</div>
                              <p className="text-sm">
                                {mission.outcome === "success"
                          ...
                          <CardFooter className="border-t border-gray-700 pt-3">
                            <div className="flex justify-between items-center w-full">
                              <div className="text-xs text-purple-400">Experience gained: +{mission.rewardXP} XP</div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                        ...
                        <Card className="bg-gray-800 border-gray-700">
                          <CardContent className="p-3 flex flex-col items-center">
                            ...
                            <Badge className="mt-1 bg-purple-900/20 text-purple-400">Locked</Badge>
                          </CardContent>
                        </Card>
                        <Card className="bg-gray-800 border-gray-700">
                          <CardContent className="p-3 flex flex-col items-center">
                            ...
                            <div className="flex justify-between items-start">
                              <div>
                                <div className="flex items-center gap-2">
                                  ...
                                  <h3 className="font-medium">Neural Interface Upgrade</h3>
                                </div>
                                <p className="text-sm text-gray-300 mt-1">
                                  Enhance neural interface capabilities, improving success rate on expose missions by
                                  10%.
                                </p>
                              </div>
                              <Badge className="bg-green-900/20 text-green-400">200 TP</Badge>
                            </div>
                            ...
                            <div className="flex justify-between items-start">
                              <div>
                                <div className="flex items-center gap-2">
                                  ...
                                  <h3 className="font-medium">Quantum Encryption</h3>
                                </div>
                                <p className="text-sm text-gray-300 mt-1">
                                  Improve stealth capabilities with advanced quantum encryption, reducing detection risk
                                  by 15%.
                                </p>
                              </div>
                              <Badge className="bg-green-900/20 text-green-400">350 TP</Badge>
                            </div>
                            <Button className="mt-3 w-full bg-green-600 hover:bg-green-700 text-black">
                              <Wrench className="h-4 w-4 mr-2" /> Upgrade
                            </Button>
                            ...
                            <div className="flex justify-between items-start">
                              <div>
                                <div className="flex items-center gap-2">
                                  ...
                                  <h3 className="font-medium">Memory Expansion</h3>
                                </div>
                                <p className="text-sm text-gray-300 mt-1">
                                  Increase experience gain from missions by 25% with enhanced memory systems.
                                </p>
                              </div>
                              <Badge className="bg-green-900/20 text-green-400">275 TP</Badge>
                            </div>
                            <Button className="mt-3 w-full bg-green-600 hover:bg-green-700 text-black">
                              <Wrench className="h-4 w-4 mr-2" /> Upgrade
                            </Button>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
              <div className="border-b border-gray-800">
                <TabsList className="bg-transparent border-b border-gray-800 rounded-none h-12 w-full justify-start">
                  ...
                  <TabsTrigger value="customize" className="data-[state=active]:bg-gray-800">
                    <Settings className="h-4 w-4 mr-2" />
                    Customize
                  </TabsTrigger>
                </TabsList>
              ...
              <TabsContent value="overview" className="flex-1 p-6 overflow-y-auto m-0 border-none">
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    {proxim8.specialization ? (
                      ...
                      <div className="bg-gray-800 p-4 rounded-md">
                        <p className="text-sm text-gray-300">
                          This Proxim8 has not yet developed a specialization. Complete more missions of a specific type
              ...
              <TabsContent value="chat" className="flex-1 flex flex-col m-0 border-none">
              ...
              <TabsContent value="history" className="flex-1 p-6 overflow-y-auto m-0 border-none">
                <h2 className="text-lg font-medium mb-4">Mission History</h2>
                <div className="space-y-4">
                  {proxim8.missionHistory.map((mission) => (
                    <Card key={mission.id} className="bg-gray-800 border-gray-700">
              ...
              <TabsContent value="customize" className="flex-1 p-6 overflow-y-auto m-0 border-none">
                <div className="space-y-6">
                  <div>
                    <h2 className="text-lg font-medium mb-4">Appearance</h2>
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                        ...
                        <CardContent className="p-4">
                          <div className="flex justify-between items-start">
                            <div>
                              ...
                              <p className="text-sm text-gray-300 mt-1">
                                Enhance neural interface capabilities, improving success rate on expose missions by 10%.
                              </p>
                            </div>
                            <Badge className="bg-green-900/20 text-green-400">200 TP</Badge>
                          </div>
