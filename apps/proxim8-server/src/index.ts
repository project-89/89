...
app.use("/api/training", trainingRoutes); // Legacy support
app.use("/api/missions", missionRoutes); // New general mission system
app.use("/api/mcp", mcpRoutes); // Mission MCP Server HTTP endpoint
