export const SUCCESS_MESSAGES = {
  ...
  // Training mission system messages
  AGENT_CREATED: 'Game agent created successfully',
  PROXIM8_REGISTERED: 'Proxim8 registered successfully',
  DEPLOYMENT_CREATED: 'Mission deployment created successfully',
  DEPLOYMENT_COMPLETED: 'Mission deployment completed successfully',
} as const;
